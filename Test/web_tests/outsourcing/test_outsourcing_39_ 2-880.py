...
@allure.story('39: 2-880 :  Создание смены более 13 часов - Версия1')
class TestOutsourcing_39(WebBase):

    @allure.title('39: 2-880 :  Создание смены более 13 часов - Версия1')
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.link(name="2-880 :  Создание смены более 13 часов - Версия1",
                 url="https://testlink.verme.ru/linkto.php?tprojectPrefix=2&item=testcase&id=2-880")
    @allure.description("Позитивный тест 2-880 :  Создание смены более 13 часов - Версия1")
    @pytest.mark.CRITICAL
    @pytest.mark.WebTest
    @pytest.mark.test2_880
    #@pytest.mark.skip
    def test_outsourcing_39(self):
        ...
        """
        Необходимо уточнить почему смена не создается
        возможно нет сотрудников
