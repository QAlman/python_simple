...
@allure.story('Test 26    Тестирование страницы "Заявки" ')
class _TestOutsourcing_26(WebBase):

    @allure.title('26: 2-1412 :   Тестирование страницы "Заявки" - Версия1')
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.link(name="2-1412 :   Тестирование страницы Заявки - Версия1",
                 url="https://testlink.verme.ru/linkto.php?tprojectPrefix=2&item=testcase&id=2-1412")
    @allure.description("Позитивный тест 2-1412 :   Тестирование страницы Заявки - Версия1")
    @pytest.mark.CRITICAL
    @pytest.mark.WebTest
    @pytest.mark.skip
    def _test_outsourcing_26(self):
