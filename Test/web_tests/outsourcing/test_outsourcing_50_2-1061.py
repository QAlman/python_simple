...
@allure.story('50: 2-1061 :  Снятие со смен (Аутсорсинг и Агенства) - Версия1')
class TestOutsourcing_50(WebBase):

    @allure.title('50: 2-1061 :  Снятие со смен (Аутсорсинг и Агенства) - Версия1')
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.link(name="2-1061 :  Снятие со смен (Аутсорсинг и Агенства) - Версия1",
    ...
    @pytest.mark.WebTest
    @pytest.mark.test2_1061
    @pytest.mark.skip
    def test_outsourcing_50(self):
