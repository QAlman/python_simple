...
# @allure.story('Test 43   Тестирование получения данных из БД ')
# class _TestOutsourcing_43(WebBase):
#
#     @allure.title('43: 2-1069 :   Тестирование получения данных из БД - Версия1')
#     @allure.severity(allure.severity_level.CRITICAL)
#     @allure.link(name="2-1069 :   Тестирование получения данных из БД - Версия1",
#                  url="https://testlink.verme.ru/linkto.php?tprojectPrefix=2&item=testcase&id=2-1070")
#     @allure.description("Позитивный тест 2-1069 :   Тестирование получения данных из БД - Версия1")
#     @pytest.mark.CRITICAL
#     @pytest.mark.WebTest
#     @pytest.mark.skip
#     def _test_outsourcing_43(self):
