...
class _TestOutsourcing_40(WebBase):
    ...
    @allure.link(name="2-1073 :  Не отрабатывает run_sync_employees при добавлении близнеца - Версия1",
                 url="https://testlink.verme.ru/index.php?caller=login&viewer=")
    @allure.description("Позитивный тест 2-1073 :  Не отрабатывает run_sync_employees при добавлении близнеца - Версия1")
    ...
    def _test_outsourcing_40(self):
        ...
        ur = "https://outsourcing-auto.verme.ru/admin/employees/agencyemployee/ "
        outsourcing.goto_employees_all_page(ur)
        outsourcing.small_time()
