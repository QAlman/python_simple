...
class TestOutsourcing_1(WebBase):
    ...
    @allure.title('1: 2-1018 : Регистрации на outsourcing-dev ')
    @allure.severity(allure.severity_level.CRITICAL)
    @allure.link(name="2-1018 : Регистрации на outsourcing-dev - Version 1", url="https://testlink.verme.ru/index.php?caller=login&viewer=")

    @allure.description("Позитивный тест 2-1018 : Регистрации на outsourcing-dev - Version 1")
