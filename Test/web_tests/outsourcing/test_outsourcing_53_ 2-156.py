...
@allure.story('53: 2-156 :  Outsourcing. Проверка "Наличие отметок" фронт (Негатив) - Версия1')
class TestOutsourcing_53(WebBase):

    @allure.title('53: 2-156 :      Outsourcing. Проверка "Наличие отметок" фронт (Негатив) - Версия1')
    ...
    @pytest.mark.WebTest
    @pytest.mark.test2_156
    #@pytest.mark.skip
    def test_outsourcing_53(self):
