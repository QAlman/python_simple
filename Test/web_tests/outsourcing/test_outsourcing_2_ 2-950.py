...
class TestOutsourcing_2(WebBase):
    ...
    @allure.link(name="2-950 :    Добавить возможность массового формирования ручных табелей для Агентства (Ди - Версия1",
                 url="https://testlink.verme.ru/linkto.php?tprojectPrefix=2&item=testcase&id=2-950")
